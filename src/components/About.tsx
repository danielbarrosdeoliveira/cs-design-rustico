  ...
  return (
    <section id="about">
        ...
        <div className="w-full flex gap-4 items-center justify-center">
          <div className="w-full flex flex-col items-center">
            ...
            <p className="text-lg text-center leading-8 mt-8">
              ...
              desde 2014, somos reconhecidos por exercer um trabalho de
              qualidade e excelência em nossos serviços. Estamos situados em
              Atibaia-SP atendemos vários estados e cidades. Trabalhamos com
              vários modelos de pedras naturais sendo Pedra Ferro, pedra moledo,
              San tomé, mosaico português... Realizamos trabalho de
              revestimentos, escadas, cascatas, muros, calçamentos, grutas e
              lagos.
            </p>
          </div>
      ...
      <div className="bg-zinc-800 px-6">
        <div className="w-full container mx-auto text-white py-8 flex flex-col text-center justify-center items-start gap-9 mt-9 lg:flex-row">
